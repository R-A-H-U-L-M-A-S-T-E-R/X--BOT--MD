...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "𝚁𝙰𝙷𝚄𝙻-𝙰𝙸;ʀᴀʜᴜʟ-ᴍᴀSᴛᴇʀ;https://i.ibb.co/JFpPYRjF/temp.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "𝚁𝙰𝙷𝚄𝙻-𝙰𝙸;ʀᴀʜᴜʟ-ᴍᴀSᴛᴇʀ;https://i.ibb.co/JFpPYRjF/temp.jpg",
	...
	PING: process.env.PING || "𝚁𝙰𝙷𝚄𝙻-𝙰𝙸",
	...
	SESSION_ID: process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:5b7c64cf53830caa1879ad599244f82f",
	START_MSG: toBool(process.env.START_MSG || "true"),
	STICKER_DATA: process.env.STICKER_DATA || `X BOT MD;ASWIN SPARKY`,
	SUDO: process.env.SUDO || "919356730236",
